...
export const dinnerMenu: MenuCategory[] = [
  {
    ...
    items: [
      { name: "Veg Samosa (2 st)", description: "Friterade smördegssnittar fyllda med grönsaker med färsk chili, koriander och rostade indiska kryddor.", price: "59 kr", spice: "mild" },
      { name: "Kött Samosa (2 st)", description: "Friterade smördegssnittar fyllda med kött, kyckling med färsk chili, koriander och rostade indiska kryddor.", price: "69 kr", spice: "medium" },
      { name: "Aloo Chana Chaat", description: "Typiska gatusnacks med kokt potatis, kikärter, röd lök, tomater, och 3 olika såser.", price: "80 kr", spice: "mild" },
      { name: "Golgappe (Pani Puri)", description: "Friterade små bröd fyllda med potatis, kikärter och yoghurt. Serveras med söt och sur sås.", price: "90 kr", spice: "medium" },
      { name: "Seekh Kabab (2 st)", description: "Lammfärs med lök, chili, vitlök och koriander, rullat på spett och kolgrillat.", price: "95 kr", spice: "spicy" },
      { name: "Chicken Tikka (3 st)", description: "Yoghurt- och kryddmarinerad kycklingfilé, kolgrillad.", price: "79 kr", spice: "medium" },
      { name: "Aloo Tikki (2 st)", description: "Potatisbiffar med färska örter och kryddor, stekta i panna.", price: "59 kr", spice: "mild" },
      { name: "Mix Pakora", description: "Grönsaker, potatis, lök, chili och blomkål doppade i kikärtsmjölsmet och friterade.", price: "69 kr", spice: "mild" },
      { name: "Chicken Pakora", description: "Strimlad kycklingfilé friterad i kikärtsmjölsmet.", price: "89 kr", spice: "medium" },
      { name: "Paneer Pakora", description: "Hemgjord ost friterad i kikärtsmjölsmet.", price: "90 kr", spice: "mild" },
      { name: "Jhinga Pakora (3 st)", description: "Räkor friterade i kikärtsmjölsmet.", price: "110 kr", spice: "medium" },
    ],
  },
  {
    ...
    items: [
      { name: "Lamm Biryani", price: "169 kr", spice: "medium" },
      { name: "Kyckling Biryani", price: "150 kr", spice: "medium" },
      { name: "Vegetarisk Biryani", price: "149 kr", spice: "mild" },
      { name: "Scampi Biryani", price: "189 kr", spice: "medium" },
    ],
  },
  {
    ...
    items: [
      { name: "Tandoori Chicken (½ kyckling, 2 ben)", price: "149 kr", spice: "spicy" },
      { name: "Tandoori Chicken (hel, 4 ben)", price: "249 kr", spice: "spicy" },
      { name: "Seekh Kabab (3 st)", price: "169 kr", spice: "spicy" },
      { name: "Chicken Tikka", price: "169 kr", spice: "medium" },
      { name: "Lamm Boti Tikka", price: "189 kr", spice: "medium" },
      { name: "Fish Tikka", price: "189 kr", spice: "medium" },
      { name: "Mix Grill", price: "249 kr", spice: "spicy" },
      { name: "Lamm Chaanp", description: "Marinerad och grillad lammkotlett.", price: "219 kr", spice: "medium" },
    ],
  },
  {
    ...
    items: [
      { name: "Lammgryta", price: "159 kr", spice: "medium" },
      { name: "Kycklinggryta", price: "149 kr", spice: "medium" },
      { name: "Biffgryta", price: "155 kr", spice: "medium" },
      { name: "Achar Gosht (biff, kyckling)", price: "169 kr / Lamm 179 kr", spice: "hot" },
      { name: "Ginger Masala (kyckling, biff)", price: "169 kr / Lamm 179 kr", spice: "spicy" },
      { name: "Jalfrezi (biff, kyckling)", price: "169 kr / Lamm 179 kr / Scampi 199 kr", spice: "hot" },
      { name: "Palak Gosht (lamm, biff, kyckling, scampi)", price: "179 kr", spice: "medium" },
      { name: "Dal Gosht (biff, kyckling)", price: "169 kr / Lamm 179 kr / Scampi 199 kr", spice: "medium" },
      { name: "Cholle Gosht (kyckling eller biff)", price: "169 kr / Lamm 179 kr", spice: "medium" },
    ],
  },
  {
    ...
    items: [
      { name: "Chicken Tikka Masala", price: "179 kr", spice: "mild" },
      { name: "Scampi Tikka Masala", price: "189 kr", spice: "mild" },
      { name: "Chicken & Scampi Tikka Masala", price: "189 kr", spice: "mild" },
      { name: "Lamm Tikka Masala", price: "189 kr", spice: "mild" },
      { name: "Zaffrani Tikka Butter Masala", price: "179 kr", spice: "mild" },
      { name: "Paneer Tikka Masala", price: "169 kr", spice: "mild" },
    ],
  },
  {
    title: "Karahi Rätter",
    ...
    items: [
      { name: "Lamb Karahi", price: "179 kr", spice: "spicy" },
      { name: "Scampi Karahi", price: "199 kr", spice: "spicy" },
      { name: "Paneer Karahi", price: "169 kr", spice: "medium" },
      { name: "Seekh Kebab Karahi", price: "159 kr", spice: "spicy" },
      { name: "Shinwari Namkeen Karahi", description: "Lamm med chili (svart, röd eller grön).", price: "179 kr", spice: "extra-hot" },
      { name: "White Butter Chicken Karahi", price: "179 kr", spice: "mild" },
      { name: "White Lamb Karahi", price: "179 kr", spice: "mild" },
      { name: "Dhaka Spicy Biff Karahi", price: "179 kr", spice: "hot" },
      { name: "Chilli Garlic Karahi (Lamm, biff, kyckling)", price: "189 kr", spice: "extra-hot" },
      { name: "Chilli Garlic Jhinga Karahi", price: "199 kr", spice: "extra-hot" },
    ],
  },
  {
