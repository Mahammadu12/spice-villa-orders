        ...
        <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-10">
          ...
          <div>
            <div className="flex items-center gap-2.5 mb-4">
              <img
                src={logoNew}
                alt="Spice Villa"
                className="h-14 rounded-full bg-white p-1"
                width={56}
                height={56}
                loading="lazy"
                decoding="async"
          ...
          <div>
            ...
            <ul className="space-y-2.5 text-sm">
              ...
              <li>
                <Link to="/meny" className="hover:text-primary transition-colors">
                  {t("Meny", "Menu")}
                </Link>
              </li>
              <li>
                <Link to="/lunch" className="hover:text-primary transition-colors">
                  {t("Lunch", "Lunch Specials")}
                </Link>
              </li>
              <li>
          ...
          <div>
            ...
            <ul className="space-y-2.5 text-sm">
              ...
              <li className="leading-relaxed">
                {t("Mån – Fre: 11:00 – 22:00", "Mon – Fri: 11:00 – 22:00")}
                <br />
                {t("Lör: 12:00 – 22:00", "Sat: 12:00 – 22:00")}
                <br />
