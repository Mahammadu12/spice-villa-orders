...
const About = () => {
  ...
  const galleryPhotos = [
    {
      src: chefExteriorImg,
      alt: t("Vår kock framför Spice Villa", "Our chef in front of Spice Villa"),
  ...
  const signatureDishes = [
    {
      ...
      name: "Nihari",
      desc: t(
        "Vår mest eftertraktade rätt Lamm som långsamt tillagas i timmar med hemliga kryddblandningar.",
        "Our most sought-after dish Lamb slowly cooked for hours with secret spice blends.",
      ),
    },
    {
      img: chapliKababImg,
      name: "Chapli Kebab",
      desc: t(
        "Kryddiga köttfärsbiffar med färska örter, tomat och granatäpple — en afghansk klassiker.",
        "Spicy minced meat patties with fresh herbs, tomato and pomegranate — an Afghan classic.",
      ),
    },
    {
      img: beefPayaImg,
      name: "Beef Paya",
      desc: t(
        "Traditionell kotlettgryta med rik buljong och aromatiska kryddor, en helgfavorit.",
        "Traditional trotters stew with rich broth and aromatic spices, a weekend favorite.",
      ),
    },
    {
      img: biryaniImg,
      name: "Biryani",
      desc: t(
        "Doftande basmatiris tillagat med saffran, hela kryddor och möra köttbitar i lager.",
        "Fragrant basmati rice cooked with saffron, whole spices and tender meat in layers.",
      ),
    },
  ];
        ...
        >
          ...
          <motion.p className="text-white/70 text-lg max-w-xl mx-auto" variants={fadeUp}>
            {t(
              ...
              "Over 20 years of passion for authentic South Asian food",
            )}
          </motion.p>
        </motion.div>
      </section>
          ...
          >
            ...
            <p className="text-muted-foreground max-w-xl mx-auto text-lg">
              {t(
                ...
                "Dishes that made us famous each a story of tradition and craftsmanship.",
              )}
            </p>
          </motion.div>
        ...
        <div className="container mx-auto px-4">
          ...
          >
            {[
              {
                icon: <Flame size={28} />,
                title: t("Kolgrillat", "Charcoal Grilled"),
                desc: t(
                  "Vi grillar över kol och i tandoori-ugn för autentisk smak.",
                  "We grill over charcoal and in tandoori oven for authentic flavor.",
                ),
              },
              {
                icon: <UtensilsCrossed size={28} />,
                title: t("Hemlagat", "Homemade"),
                desc: t(
                  "Alla rätter tillagas från grunden med färska råvaror varje dag.",
                  "All dishes are prepared from scratch with fresh ingredients every day.",
                ),
              },
              {
                icon: <Award size={28} />,
                title: "100% Halal",
                desc: t(
                  "All vår mat är halal-certifierad och noggrant utvald.",
                  "All our food is halal-certified and carefully selected.",
                ),
              },
              {
                icon: <ChefHat size={28} />,
                title: t("Erfarna Kockar", "Experienced Chefs"),
                desc: t(
                  "Vårt köksteam har decennier av erfarenhet från hela Sydasien.",
                  "Our kitchen team has decades of experience from across South Asia.",
                ),
              },
            ].map((item) => (
              <motion.div
          ...
          >
            ...
            <p className="text-muted-foreground max-w-lg mx-auto">
              {t(
                ...
                "A glimpse into our dining area, kitchen and passionate team.",
              )}
            </p>
          </motion.div>
          ...
          <motion.div initial="hidden" whileInView="visible" viewport={{ once: true }} variants={fadeUp}>
            ...
            <p className="text-muted-foreground mb-8 max-w-md mx-auto">
              {t(
                ...
                "We look forward to welcoming you to Spice Villa.",
              )}
            </p>
